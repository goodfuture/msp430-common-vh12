...
//extern unsigned char xdata PO_SerialNum[6][16];	//污染物代码表 序号
//extern unsigned char xdata PO_Type[6];					//污染物种类 Gas(1) or Water(0)
...
void Mod_dealdata(INT8U *receive)
{
  ...
  if((CRC16[0]==*(receive+7))&&(CRC16[1]==*(receive+8))&&(*(receive+1)==0x03))	//高低位判别？
  {
